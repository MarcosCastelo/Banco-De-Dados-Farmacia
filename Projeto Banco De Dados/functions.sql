...
SELECT BUSCALOCAL(1);
SELECT VERIFICALOCAL(6);
SELECT 
SELECT LOJA.ENDERECO FROM LOJA WHERE LOJA.ENDERECO LIKE 'SAO JOAQUIM'
SELECT LOCAL.BAIRRO FROM LOCAL WHERE LOCAL_ID = 1;

SELECT CADASTRACLIENTE('123','123','123','123','01-01-2000', TRUE);
